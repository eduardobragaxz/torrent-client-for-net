...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        torrentClient = new TorrentClient.TorrentClient(4000, @".\Test")
        {
            DownloadSpeedLimit = 100 * 1024, // 100 KB/s
            UploadSpeedLimit = 200 * 1024 // 200 KB/s
        }; // listening port, base torrent data directory
