...
public class AnnounceMessage : TrackerMessage
{
    ...
    public override int Encode(byte[] buffer, int offset)
    {
        ...
        Message.Write(buffer, ref written, ConnectionId);
        Message.Write(buffer, ref written, (int)Action);
        Message.Write(buffer, ref written, TransactionId);
        Message.Write(buffer, ref written, InfoHash.ToByteArray());
        Message.Write(buffer, ref written, Message.FromPeerId(PeerId));
        Message.Write(buffer, ref written, Downloaded);
        Message.Write(buffer, ref written, Left);
        Message.Write(buffer, ref written, Uploaded);
        Message.Write(buffer, ref written, (int)TrackingEvent);
        Message.Write(buffer, ref written, Endpoint.Address == IPAddress.Loopback ? 0 : BitConverter.ToInt32(Endpoint.Address.GetAddressBytes(), 0));
        Message.Write(buffer, ref written, Key);
        Message.Write(buffer, ref written, NumberWanted);
        Message.Write(buffer, ref written, (ushort)Endpoint.Port);
