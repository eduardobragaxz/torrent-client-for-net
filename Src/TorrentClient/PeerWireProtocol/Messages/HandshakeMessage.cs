...
public class HandshakeMessage : PeerMessage
{
    ...
    public override int Length
    {
        get
        {
            return NameLengthLength + ProtocolString!.Length + ReservedLength + InfoHashLength + PeerIdLength;
        }
    }
    ...
    public override int Encode(byte[] buffer, int offset)
    {
        ...
        Message.Write(buffer, ref written, (byte)ProtocolString?.Length);
        Message.Write(buffer, ref written, ProtocolString);
    ...
    {
        if (obj is not HandshakeMessage msg)
        {
            return false;
        }
        else
    ...
    {
        return InfoHash.GetHashCode(StringComparison.InvariantCulture) ^
