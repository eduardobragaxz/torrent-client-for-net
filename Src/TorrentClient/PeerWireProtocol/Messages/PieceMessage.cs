...
public class PieceMessage : PeerMessage
{
    ...
    public override int Length
    {
        get
        {
            return MessageLengthLength + MessageIdLength + PieiceIndexLength + BlockOffsetLength + BlockDataLength;
        }
    }
    ...
    public override int Encode(byte[] buffer, int offset)
    {
        ...
        Message.Write(buffer, ref written, MessageIdLength + PieiceIndexLength + BlockOffsetLength + Data.Length);
        Message.Write(buffer, ref written, MessageId);
        Message.Write(buffer, ref written, PieceIndex);
        Message.Write(buffer, ref written, BlockOffset);
        Message.Write(buffer, ref written, Data);
    ...
    {
        if (obj is not PieceMessage msg)
        {
            return false;
        }
        else if (PieceIndex == msg.PieceIndex &&
