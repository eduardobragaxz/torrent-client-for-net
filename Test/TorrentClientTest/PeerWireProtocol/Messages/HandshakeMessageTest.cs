...
public class HandshakeMessageTest
{
    ...
    public void HandshakeMessage_TryDecode()
    {
        ...
        if (HandshakeMessage.TryDecode(data, ref offset, data.Length, out HandshakeMessage message, out bool isIncomplete))
        {
            ...
            Assert.IsTrue(message.SupportsExtendedMessaging);
            Assert.IsTrue(message.SupportsFastPeer);
