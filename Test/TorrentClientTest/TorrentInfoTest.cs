...
/// </summary>
[TestClass]
public partial class TorrentInfoTest
{
    ...
    {
        string filePath;
        Regex regex = HashRegex();
        int i = 0;

        filePath = @"..\..\..\TorrentClientTest.Data\Torrent1.torrent";

        // multi file
        if (TorrentInfo.TryLoad(filePath, out TorrentInfo info))
        {
    ...
    [GeneratedRegex("[a-zA-Z0-9+/=]{28}", RegexOptions.Compiled)]
